...
export default function AuthScreen() {
  ...
  const signupForm = useForm<SignupFormData>({
    defaultValues: { name: '', email: '', password: '', plan: 'free', agreeTerms: false },
  });
  ...
  return (
    <div className="min-h-screen bg-[#080812] flex overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-8">
          <div>
            <h1 className="font-display text-5xl xl:text-6xl font-bold leading-tight mb-4">
              <span className="text-white">Your ideas deserve</span>
              <br />
              <span className="text-gradient">to go viral.</span>
            </h1>
            <p className="text-white/50 text-lg leading-relaxed max-w-md">
              Join 47,000+ creators who turn raw ideas into scroll-stopping content in under 60 seconds.
            </p>
          </div>
          ...
          <div className="glass rounded-2xl p-5 border border-white/8 max-w-md">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-white text-xs font-semibold">Priya K.</p>
                <p className="text-white/40 text-[11px]">@priyacreates · 280k followers</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10">
          <p className="text-white/20 text-xs">© 2026 VYRO. All rights reserved.</p>
        </div>
      </div>
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className="flex gap-3 mb-6">
            <button
              ...
              className="flex-1 glass border border-white/10 rounded-xl py-3 flex items-center justify-center gap-2 text-white/70 hover:text-white hover:border-white/20 transition-all duration-200 text-sm font-medium"
            >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-10 py-3 rounded-xl glass border border-white/10 text-white text-sm placeholder:text-white/25 focus:outline-none focus:border-purple-500/50 transition-colors duration-200 bg-transparent"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
            ...
            <form onSubmit={signupForm.handleSubmit(handleSignup)} className="space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    ...
                    { value: 'pro', label: 'Pro', sub: '$14/mo' },
                    { value: 'ultra', label: 'Ultra', sub: '$39/mo' },
                  ].map((plan) => {
              ...
              <div>
                ...
                {signupForm.formState.errors.agreeTerms && (
                  <p className="text-red-400 text-xs mt-1">{signupForm.formState.errors.agreeTerms.message}</p>
                )}
              </div>
