      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8 text-white/60 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>If you have questions about these Terms, please contact us at <a href="mailto:hello@creo.ai" className="text-purple-400 hover:text-purple-300">hello@creo.ai</a>.</p>
          </section>
