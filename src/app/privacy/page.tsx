      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8 text-white/60 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p><strong className="text-white/80">2.1 Information you provide directly:</strong></p>
            ...
            <p className="mt-2"><strong className="text-white/80">2.2 Information collected automatically:</strong></p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-3">4. Legal Basis for Processing (GDPR)</h2>
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-3">5. How We Share Your Information</h2>
            <p>We do not sell your personal information. We may share information in the following limited circumstances:</p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li><strong className="text-white/80">AI service providers:</strong> Your prompts are transmitted to third-party AI providers (such as Google Gemini) solely to generate the content you request. These providers process data under their own privacy commitments.</li>
              <li><strong className="text-white/80">Payment processors:</strong> Billing details are shared with payment processors (such as Razorpay or Stripe) to process subscription payments securely.</li>
              <li><strong className="text-white/80">Service providers:</strong> We may share data with hosting providers, analytics services, and customer support tools that help us operate the Service, under contractual confidentiality obligations.</li>
              <li><strong className="text-white/80">Legal requirements:</strong> We may disclose information if required by law, court order, or governmental request, or to protect the rights, property, or safety of CRÉO, our users, or others.</li>
              <li><strong className="text-white/80">Business transfers:</strong> If CRÉO is involved in a merger, acquisition, or sale of assets, your information may be transferred as part of that transaction, subject to confidentiality commitments.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-white font-semibold text-base mb-3">6. Data Storage, Security & Retention</h2>
            <p><strong className="text-white/80">6.1 Storage.</strong> Account data is currently stored locally on your device via browser storage during our early-access phase. As CRÉO scales, we will migrate to secure encrypted cloud infrastructure, and will notify users in advance of this transition along with updated terms.</p>
            <p className="mt-2"><strong className="text-white/80">6.2 Security Measures.</strong> We implement industry-standard technical and organisational measures to protect your data, including encryption in transit (HTTPS/TLS), access controls, and regular security reviews. However, no method of transmission or storage is 100% secure, and we cannot guarantee absolute security.</p>
            <p className="mt-2"><strong className="text-white/80">6.3 Retention.</strong> We retain your personal data for as long as your account is active or as needed to provide the Service. If you delete your account, we will delete or anonymise your personal data within 30 days, except where retention is required for legal, tax, accounting, or dispute-resolution purposes.</p>
          </section>

          <section>
            <h2 className="text-white font-semibold text-base mb-3">7. International Data Transfers</h2>
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-3">8. Cookies & Tracking Technologies</h2>
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-3">9. Your Privacy Rights</h2>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              ...
              <li><strong className="text-white/80">Deletion:</strong> Request deletion of your account and associated personal data</li>
              <li><strong className="text-white/80">Portability:</strong> Request your data in a structured, machine-readable format</li>
              <li><strong className="text-white/80">Objection / Restriction:</strong> Object to or request restriction of certain processing activities</li>
            ...
            <p className="mt-2">To exercise any of these rights, email <a href="mailto:hello@creo.ai" className="text-purple-400 hover:text-purple-300">hello@creo.ai</a>. We will respond to verified requests within 30 days, or as required by applicable law. You may also delete your account directly from Settings at any time.</p>
          </section>

          <section>
            <h2 className="text-white font-semibold text-base mb-3">10. AI-Generated Content & Your Prompts</h2>
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-3">13. Changes to This Privacy Policy</h2>
          ...
          <section>
            ...
            <p>If you have questions, concerns, or requests regarding this Privacy Policy or our data practices, please contact us at <a href="mailto:hello@creo.ai" className="text-purple-400 hover:text-purple-300">hello@creo.ai</a>. We aim to respond to all privacy-related inquiries within 7 business days.</p>
          </section>
