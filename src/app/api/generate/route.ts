...
// ✅ REGIONAL-LANGUAGE SUPPORT — CRÉO's prompts used to be English-only by
// default: a Hindi/Tamil/Telugu/Marathi/Bengali (or any other language) idea
// could come back in English, or an inconsistent mix, purely by luck of the
// model. This makes language-matching an explicit instruction on every single
